...
public class UpComingRemindersActivity extends AppCompatActivity implements ReminderUpdateCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adap = new CustomAdapter_UpcomingRemindersListing(this,list,"show",database);
        lv.setAdapter(adap);
    ...
    public void Callon() {
     ...
     adap = new CustomAdapter_UpcomingRemindersListing(UpComingRemindersActivity.this,list,"show",database);
     lv.setAdapter(adap);
    }
}
